...
define('WP_HOME', SITE_URLS[PRODUCTION]);
define('WP_SITEURL', SITE_URLS[PRODUCTION]);

/** The name of the database for WordPress */
define('DB_NAME', PRODUCTION ? 'u472312318_moithue' : 'apz_moithue');

/** Database username */
define('DB_USER', PRODUCTION ? 'u472312318_moithue' : 'root');

/** Database password */
define('DB_PASSWORD', PRODUCTION ? 'Siy@mcse@30' : '');
...
//  * @package WordPress
//  */
// define('WP_HOME', 'https://moithue.appszonebd.com');
// define('WP_SITEURL', 'https://moithue.appszonebd.com');
// // ** Database settings - You can get this info from your web host ** //
// /** The name of the database for WordPress */
// define( 'DB_NAME', 'u472312318_moithue' );

// /** Database username */
// define( 'DB_USER', 'u472312318_moithue' );

// /** Database password */
// define( 'DB_PASSWORD', 'Siy@mcse@30' );
