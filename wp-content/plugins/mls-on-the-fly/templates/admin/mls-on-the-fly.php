    ...
    <div id="mls-otf-demo-wizard" class="mls-otf-wizard-container" style="display: none;">
        ...
        <div class="mls-otf-wizard-step" id="step-1">
            ...
            <ol>
                ...
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/sign-up.png' ?>" alt="Sign Up Image"
                     style="max-width:100%;">
                ...
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/verify.png' ?>" alt="Verify Email Image"
                     style="max-width:100%;">
            </ol>
            <div class="mls-otf-button-group">
        ...
        <div class="mls-otf-wizard-step" id="step-2" style="display: none;">
            ...
            <ol>
                ...
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/choose-mls-demo-package.png' ?>"
                ...
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/select-mls.png' ?>" alt="Select MLS"
                     style="max-width:100%;">
                <li><strong>Proceed to Checkout:</strong> After selecting the MLS demo package, proceed to checkout.
                </li>
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/checkout.png' ?>" alt="Checkout Image"
                     style="max-width:100%;">
            </ol>
            <div class="mls-otf-button-group">
                <button class="mls-otf-wizard-btn btn-prev">Previous</button>
        ...
        <div class="mls-otf-wizard-step" id="step-3" style="display: none;">
            ...
            <ol>
                ...
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/api-keys.png' ?>" alt="API Keys Image"
                     style="max-width:100%;">
    ...
    <div id="mls-otf-realdata-wizard" class="mls-otf-wizard-container" style="display: none;">
        ...
        <div class="mls-otf-wizard-step" id="step-2" style="display: none;">
            ...
            <ol>
                ...
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/mls-verification.png' ?>" alt="API Keys Image"
                     style="max-width:100%;">
                ...
                <img src="<?php
                echo REALTYNA_MLS_ON_THE_FLY_URL . 'assets/image/wizards/select-real-mls.png' ?>" alt="API Keys Image"
                     style="max-width:100%;">
