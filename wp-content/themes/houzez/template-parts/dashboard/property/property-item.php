...
<tr>
    ...
    <td>
        <?php
            ...
            echo '<br>';
            echo empty($post_author) 
                ? __('by a guest', 'houzez') 
                : sprintf(__('by %s', 'houzez'), '<a href="' . esc_url(add_query_arg('user', $post_author, $listings_page)) . '">' . get_the_author() . '</a>');
        ?>
    </td>
        ...
        <div class="dropdown property-action-menu">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                ...
                <?php if (houzez_is_published($post->ID) && houzez_option('enable_mark_as_sold', 0)) { ?>
                    <a href="#" class="mark_as_sold_js dropdown-item" data-property="<?php echo $post_id ?>" data-nonce="<?php echo wp_create_nonce('sold_property_nonce'); ?>"> 
