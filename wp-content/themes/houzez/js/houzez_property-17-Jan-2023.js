    ...
    if (typeof houzezProperty !== "undefined") {
        ...
        var property_gallery_images = function () {
            ...
            plup_uploader.bind("FilesAdded", function (up, files) {
                ...
                var cur_files = $(
                    "#houzez_property_gallery_container .property-thumb"
                ).not(".houzez-during-upload").length;

                var uploaded_files = $(
                    "#houzez_property_gallery_container .houzez-during-upload"
                ).length;
